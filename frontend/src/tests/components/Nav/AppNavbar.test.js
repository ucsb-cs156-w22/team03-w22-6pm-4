...
describe("AppNavbar tests", () => {
    ...
    test("renders the subjects menu correctly for a user", async () => {
        const currentUser = currentUserFixtures.userOnly;
        const systemInfo = systemInfoFixtures.showingBoth;
    ...
    test("renders the subjects menu correctly for an admin", async () => {
        const currentUser = currentUserFixtures.adminUser;
        const systemInfo = systemInfoFixtures.showingBoth;
    ...
    test("renders the subreddits menu correctly for a user", async () => {
        const currentUser = currentUserFixtures.userOnly;
        const systemInfo = systemInfoFixtures.showingBoth;
    ...
    test("renders the subreddits menu correctly for an admin", async () => {
        const currentUser = currentUserFixtures.adminUser;
        const systemInfo = systemInfoFixtures.showingBoth;
